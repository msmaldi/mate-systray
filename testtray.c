...
static void
another_tray(GdkScreen *screen)
{
  GtkWidget *window = gtk_window_new (GTK_WINDOW_TOPLEVEL);

  GtkWidget *traybox = na_grid_new (GTK_ORIENTATION_HORIZONTAL);
  na_grid_set_min_icon_size(NA_GRID(traybox), 200);

  gtk_container_add (GTK_CONTAINER (window), traybox);
